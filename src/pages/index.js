        ...
        <div className='flex flex-col w-full space-y-5'>
          <div className='flex flex-col w-full p-10 space-y-5 bg-white border border-gray-300'>
            <form onSubmit={submitHandler} className='flex flex-col items-center space-y-5'>
              ...
              <input type='password' name='password' id='password' onChange={onChangeHandler} value={form.password} className='w-full px-2 py-1 bg-gray-100 border rounded-sm outline-none hover:bg-transparent focus:bg-transparent placeholder:text-sm focus:border-gray-400' placeholder='Password' />
              <button type='submit' className='bg-[#0095F6] py-1 text-white active:scale-95 transform transition w-full disabled:bg-opacity-50 disabled:scale-100 rounded text-sm font-semibold' disabled={isDisabled}>Log In</button>
            </form>
              ...
              <div className='w-full text-xs text-center text-indigo-900'>Forgotten your password?</div>
          </div>
          <div className='w-full py-5 space-y-5 text-sm text-center bg-white border border-gray-300'>Don&apos;t have an account? Sign up</div>
          <span className='ml-2 font-semibold text-indigo-600'>Sign up</span>
        </div>
      </div>
    </div>
  )
